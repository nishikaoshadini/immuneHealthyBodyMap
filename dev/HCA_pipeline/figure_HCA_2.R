...
# data_for_immune_proportion = readRDS("~/PostDoc/CuratedAtlasQueryR/dev/data_for_immune_proportion.rds")
...
# Sex
differential_composition_sex_relative = readRDS("~/PostDoc/CuratedAtlasQueryR/dev/run_30_nov_2022/immune_non_immune_differential_composition_sex_relative2.rds")
differential_composition_sex_absolute = readRDS("~/PostDoc/CuratedAtlasQueryR/dev/immune_non_immune_differential_composition_sex_absolute2.rds")
...
proportions_sex_absolute_adjusted = readRDS("~/PostDoc/CuratedAtlasQueryR/dev/proportions_sex_absolute_adjusted.rds")
...
#   saveRDS("~/PostDoc/CuratedAtlasQueryR/dev/proportions_sex_relative_adjusted.rds")
...
differential_composition_ethnicity_absolute = readRDS("~/PostDoc/CuratedAtlasQueryR/dev/immune_non_immune_differential_composition_ethnicity_absolute2.rds")
...
proportions_ethnicity_tissue_absolute_adjusted =
  readRDS("~/PostDoc/CuratedAtlasQueryR/dev/proportions_ethnicity_tissue_absolute_adjusted.rds")
...
# # Relative
differential_composition_ethnicity_relative = readRDS("~/PostDoc/CuratedAtlasQueryR/dev/immune_non_immune_differential_composition_ethnicity_relative2.rds")
#
