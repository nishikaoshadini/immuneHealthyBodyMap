...
res_absolute = readRDS("~/PostDoc/HCAquery/dev/sccomp_on_HCA/tissue_absolute_FALSE.rds")
data_for_immune_proportion = readRDS("~/PostDoc/HCAquery/dev/sccomp_on_HCA/input_absolute.rds")
res_absolute_adjusted = readRDS("~/PostDoc/HCAquery/dev/sccomp_on_HCA/tissue_absolute_FALSE_proportion_adjusted.rds")
proportions_tissue_replicate = readRDS("~/PostDoc/HCAquery/dev/sccomp_on_HCA/tissue_")
