...
variable_features <- readRDS("variable_features__other_T.rds")  ## 3244 genes
...
# immune.combined = readRDS("temp_immune.combined.rds")
#
...
#
# immune.combined |> DimPlot(group.by = "file")
